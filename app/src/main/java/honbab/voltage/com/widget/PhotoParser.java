...
public class PhotoParser {
    ...
    private HashMap<String, Object> getPlace(JSONObject googlePlaceJson) {
        ...
        ArrayList<FeedData> photos = new ArrayList<>();
        ...
        try {
            ...
            if (!googlePlaceJson.isNull("photos")) {
                ...
                for (int i=0; i<photoArr.length(); i++) {
                    ...
                    feedData.setHeight(Integer.parseInt(height));
                    feedData.setRest_img(photo_reference);
                    feedData.setWidth(Integer.parseInt(width));
