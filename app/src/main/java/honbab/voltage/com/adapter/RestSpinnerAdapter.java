...
public class RestSpinnerAdapter extends RecyclerView.Adapter<RestSpinnerAdapter.ViewHolder> {
    private Context mContext;
    public ArrayList<UserData> listViewItemList = new ArrayList<>();
    public ArrayList<UserData> newList = new ArrayList<>();

    public RestSpinnerAdapter(Context context) {
        this.mContext = context;
    }

    public RestSpinnerAdapter(Context context, ArrayList<UserData> listViewItemList) {
        this.mContext = context;
