...
//            pattern = Pattern.compile(context.getString(R.string.pattern_alphanumeric));
            pattern = Pattern.compile(context.getString(R.string.pattern_hangul));
        } else {
            pattern = Pattern.compile(context.getString(R.string.pattern_alphanumeric_hangul));
        }
...
//            if (stringBuilder.toString().matches("[0-9|a-z|A-Z|ㄱ-ㅎ|ㅏ-ㅣ|가-힝]*")) {
                ...
                if (mode == ALLOW_ALPHANUMERIC) {
                    ...
                    showToast(context.getString(R.string.input_error_alphanumeric_hangul));
                }
