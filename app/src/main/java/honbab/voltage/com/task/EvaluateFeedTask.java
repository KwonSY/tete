...
public class EvaluateFeedTask extends AsyncTask<String, Void, Void> {
    ...
    public EvaluateFeedTask(Context mContext) {
...
//        }
    ...
    protected Void doInBackground(String... objects) {
        FormBody body = new FormBody.Builder()
                .add("opt", "evaluate_feed")
                .add("user_id", objects[0])
                .add("feed_id", objects[1])
                .add("rating", objects[2])
                .add("status", objects[3])
                .build();
