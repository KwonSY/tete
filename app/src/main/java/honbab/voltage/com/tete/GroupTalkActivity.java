...
//                restData = new RestData();
            ...
            if (fromId == null) {
                ...
                Intent intent1 = new Intent(GroupTalkActivity.this, MainActivity.class);
...
//        setDrawerReserv();
    ...
    protected void onResume() {
        ...
        if (NetworkUtil.isOnline(this)) {
            ...
            new CommonRestTask(GroupTalkActivity.this, httpClient).execute(toId, null);
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.no_chat_img_user:
                    ...
                    Intent intent2 = new Intent(GroupTalkActivity.this, ProfileActivity.class);
...
//        });
        ...
        try {
            restList = new CommonRestTask(GroupTalkActivity.this, httpClient).execute(toId, restData.getRest_id()).get();
