...
public class DaumMapActivity2 extends AppCompatActivity {

//    private static final String DAUM_API_KEY = "7e146f9c98e75bf4dde5b028ccd06aa4";

    @Override
    protected void onCreate(Bundle saveInstanceState) {
        super.onCreate(saveInstanceState);
        setContentView(R.layout.fragment_daummap2);
